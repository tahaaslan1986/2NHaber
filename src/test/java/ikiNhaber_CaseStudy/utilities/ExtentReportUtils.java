...
public class ExtentReportUtils {
    ...
    public static void addScreenShotToReport() {
        String date = DateTimeFormatter.ofPattern("ddMMyyyy_HHmmss").format(LocalDateTime.now());
        String path = "src\\test\\java\\alloverTestOps\\testOutputs\\screenshots" + date + ".png";
    ...
    public static void addScreenShotOfWebElementToReport(WebElement webElement) {
        String date = DateTimeFormatter.ofPattern("ddMMyyyy_HHmmss").format(LocalDateTime.now());
        String path = "src\\test\\java\\alloverTestOps\\testOutputs\\webElementScreenshots" + date + ".png";
        try {
    ...
    /**
     * Bu metot, skip (atlanan) testler için rapora bir mesaj ekler.
     *
     * @param message
     */
