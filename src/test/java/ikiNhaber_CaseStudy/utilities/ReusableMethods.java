...
public class ReusableMethods {
    ...
    */
    ...
    public static void screenShot(String name) {
        ...
        String dosyaYolu = System.getProperty("user.dir") + "/src/test/java/ikiNhaber_CaseStudy/testOutputs/screenshots" + name + date + ".png";
        try {
...
//webelement screenshot
    public static void   screenShotOfWebElement(WebElement webElement){
        String date = DateTimeFormatter.ofPattern("ddMMyyyy_HHmmss").format( LocalDateTime.now() );
        String dosyaYolu = System.getProperty("user.dir") + "/src/test/java/ikiNhaber_CaseStudy/testOutputs/webElementScreenshots" +  date + ".png";
        try {
...
//    //SignIn AlloverCommerceTestNG_Proje
//    public static void signIn(){
//        Driver.getDriver().get(ConfigReader.getProperty("ikiNhaberUrl"));
//        HomePage homePage=new HomePage();
//        LoginPage loginPage=new LoginPage();
//        homePage.signIn.click();
//        loginPage.usernameTextBox.sendKeys(ConfigReader.getProperty("ikiNhaberUrl"));
//        loginPage.passwordTextBox.sendKeys(ConfigReader.getProperty("ikiNhaberUrl"));
//        loginPage.signInButton.click();
//
//    }

    //SignInVendor AlloverCommerceTestNG_Proje
//    public static void signInVendor(){
//        Driver.getDriver().get(ConfigReader.getProperty("ikiNhaberUrl"));
//        HomePage homePage=new HomePage();
//        homePage.signIn.click();
//        LoginPage loginPage = new LoginPage();
//        loginPage.usernameTextBox.sendKeys(ConfigReader.getProperty("vendorCorrectEmail"));
//        loginPage.passwordTextBox.sendKeys(ConfigReader.getProperty("vendorCorrectPassword"));
